...
Blodgett et al.  \cite{blodgett-etal-2020-language} critiqued much of existing work regarding fairness in LLMs for failing to state what is harmful, in what way, to whom and why. We aim to clarify the \textit{what} and \textit{in what way} based on the literature and the \textit{to whom} and \textit{why} through our own investigations for safety evaluations:
